  ...
  <div class="home" id="home" name="home">
    ...
    <div class="main-box">
      <div class="main">
        ...
        <div class="phone">
          <div class="box-hd">
            <div class="title">爱情鲜花 <span class="text-bold">|送让你怦然心动的人</span></div>
          </div>
          <div class="box-bd">
            <div class="promo-list">
              <router-link to>
                <img :src="$target +'public/imgs/muens/home_floor_lover.png'" />
              </router-link>
            </div>
            <div class="list">
        ...
        <div class="appliance" id="promo-menu">
          <div class="box-hd">
            <div class="title">长辈鲜花<span class="text-bold">|感恩他们对你的教诲</span></div>
          ...
          <div class="box-bd">
            <div class="promo-list">
              <router-link to>
                <img :src="$target +'public/imgs/muens/home_floor_elder.png'" />
              </router-link>
           <!--   <ul>
                <li>
        ...
        <div class="accessory" id="promo-menu">
          <div class="box-hd">
            <div class="title">永生花<span class="text-bold">|许 · 她一生承诺</span></div>
            <div class="more" id="more">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <router-link to>
                <img :src="$target +'public/imgs/muens/home_floor_song.jpg'" />
              </router-link>
<!--              <ul>
                <li>
...
export default {
  ...
  created() {
    ...
    // 获取各类商品数据
    this.getPromo("爱情鲜花", "phoneList");
    this.getPromo("长辈鲜花", "miTvList");
    this.getPromo("永生花", "protectingShellList");
    this.getPromo("蛋糕", "chargerList");
    this.getPromo(
      ["长辈鲜花", "永生花", "蛋糕"],
      "applianceList",
